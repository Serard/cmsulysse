...
class LoadUserData extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        $users = array(
            ...
            array(
                'roles' => array('ROLE_USER'),
                'email' => 'marina.sanka@gmail.com',
                'username' => 'marina.sanka@gmail.com',
                'lastname' => 'Sanka',
                'firstname' => 'Marina',
                'streetNumber' => '14',
                'address' => 'Rue Hoche',
            ...
            array(
                'roles' => array('ROLE_USER'),
                'email' => 'maya.launey@yopmail.fr',
                'username' => 'maya.launey@yopmail.fr',
                'lastname' => 'Launey',
                'firstname' => 'Maya',
                'streetNumber' => '14',
                'address' => 'chemin le clos le prieuré',
                'administrativeArea' => 'Île-de-France',
                'postalCode' => '91490',
                'country' => 'France',
                'city' => 'Oncy sur Ecole',
            ...
            array(
                'roles' => array('ROLE_USER'),
                'email' => 'jerome@yopmail.fr',
                'username' => 'jerome@yopmail.fr',
                'lastname' => 'Martin',
                'firstname' => 'Jerome',
                'streetNumber' => '89',
            ...
            array(
                'roles' => array('ROLE_USER'),
                'email' => 'mathieuLautre@yopmail.fr',
                'username' => 'mathieuLautre@yopmail.fr',
                'lastname' => 'Lautre',
                'firstname' => 'Mathieu',
                'streetNumber' => '68',
                'address' => 'Rue Hoche',
            ...
            array(
                'roles' => array('ROLE_USER'),
                'email' => 'florence@yopmail.fr',
                'username' => 'florence@yopmail.fr',
                'lastname' => 'LaBelle',
                'firstname' => 'Florence',
                'streetNumber' => '2',
                'address' => 'rue paul bert',

...
(function(factory) {
    ...
    Plugin.prototype = {
        ...
        _generateMarkup: function() {
            ...
            // CSS contener de la fleche
            var arrowparent = $("<div>", {
                "class": "arrowParent"
            }).appendTo(this.selectedFlagInner);

            //Code Country au niveau du drap
            var codeCountryDiv = $("<div>", {
                "class": "codeCountry"
            }).appendTo(this.selectedFlagInner);
        ...
        _selectFlag: function(countryCode) {
            ...
            //def du code country
            var codeCountrySelect = "+" + this.selectedCountryData.dialCode;
            this.selectedFlagInner.children().last().empty();
            this.selectedFlagInner.children().last().append(codeCountrySelect);
